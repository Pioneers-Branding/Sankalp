...
<?php include_once __DIR__ . '/../includes/analytics.php'; ?>
  ...
  <title>Dr. Lata Goyal | Best Obstetrics & Gynaecology Specialist in Ambikapur | Sankalp Hospital</title>
  <meta name="description" content="Consult Dr. Lata Goyal, MBBS, MS (Obstetrics & Gynaecology) | Senior Consultant & IVF Specialist at Sankalp Hospital in Ambikapur. Dr. Lata Goyal is a renowned Gynecologist and Infertility Specialist based in Ambikapur. With over 15 years of experience, she has pioneered assisted reproductive technologies (ART) in the Surguja district. She is known for her compassionate care and high success rates in IVF and normal deliveries.">
  ...
  <div class="container">
    ...
    <div class="dp-breadcrumb">
      <div class="dp-breadcrumb-list">
        ...
        <span class="sep"><i class="fas fa-chevron-right"></i></span>
        <span class="current">Dr. Lata Goyal</span>
      </div>
    </div>
    ...
    <div class="row align-items-center g-4 g-lg-5 mt-2">
      ...
      <div class="col-lg-4 col-md-5">
        <div class="dp-photo-wrapper">
          <div class="dp-photo-card">
            <img src="/images/lata-goyal.jpg" alt="Dr. Lata Goyal" onerror="this.src='/images/doc1.png'">
      ...
      <div class="col-lg-8 col-md-7">
        <div class="dp-hero-content">
          ...
          <h1 class="dp-hero-name">Dr. Lata Goyal</h1>
          <p class="dp-hero-degrees">MBBS, MS (Obstetrics &amp; Gynaecology) | Senior Consultant &amp; IVF Specialist</p>
          <p class="dp-hero-bio">Dr. Lata Goyal is a renowned Gynecologist and Infertility Specialist based in Ambikapur. With over 15 years of experience, she has pioneered assisted reproductive technologies (ART) in the Surguja district. She is known for her compassionate care and high success rates in IVF and normal deliveries.</p>
      ...
      <div class="col-lg-7">
        <div class="dp-profile-card">
          ...
          <div class="dp-expertise-grid">
            ...
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> IVF &amp; Infertility</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Laparoscopic Gynaec Surgery</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> PCOS Management</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Prenatal Care</span>
          </div>
          ...
          <div class="dp-qual-box">
            ...
            <ul class="dp-qual-list">
                ...
                <li>Senior Consultant &amp; IVF Specialist</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-5">
        <div class="dp-sticky-sidebar">
          ...
          <div class="dp-book-card">
            ...
            <p class="dp-book-sub">Schedule a consultation with Dr. Lata Goyal. Our coordinator will reach out to confirm.</p>
            <form id="detailed-booking-form" class="appointment-form">
              <input type="hidden" id="book-dept" value="obstetrics">
              <input type="hidden" id="book-doc" value="Dr. Lata Goyal">
              <div class="mb-3">
