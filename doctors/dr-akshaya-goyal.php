...
<?php include_once __DIR__ . '/../includes/analytics.php'; ?>
  ...
  <title>Dr. Akshaya Goyal | Best Ophthalmology (Eye Care) Specialist in Ambikapur | Sankalp Hospital</title>
  <meta name="description" content="Consult Dr. Akshaya Goyal, MBBS, MS (Ophthalmology) | Consultant Ophthalmologist at Sankalp Hospital in Ambikapur. Dr. Akshaya Goyal is a skilled Eye Specialist at Sankalp Hospital, dedicated to providing advanced eye care services. He specializes in modern cataract surgery and managing complex eye conditions, ensuring clear vision for his patients in Ambikapur.">
  ...
  <div class="container">
    ...
    <div class="dp-breadcrumb">
      <div class="dp-breadcrumb-list">
        ...
        <span class="sep"><i class="fas fa-chevron-right"></i></span>
        <span class="current">Dr. Akshaya Goyal</span>
      </div>
    </div>
      ...
      <div class="col-lg-4 col-md-5">
        <div class="dp-photo-wrapper">
          <div class="dp-photo-card">
            <img src="/images/akshaya-goyal.jpg" alt="Dr. Akshaya Goyal" onerror="this.src='/images/doc1.png'">
      ...
      <div class="col-lg-8 col-md-7">
        <div class="dp-hero-content">
          <span class="dp-specialty-tag">
            <i class="fas fa-stethoscope"></i> Ophthalmology (Eye Care)
          </span>
          <h1 class="dp-hero-name">Dr. Akshaya Goyal</h1>
          <p class="dp-hero-degrees">MBBS, MS (Ophthalmology) | Consultant Ophthalmologist</p>
          <p class="dp-hero-bio">Dr. Akshaya Goyal is a skilled Eye Specialist at Sankalp Hospital, dedicated to providing advanced eye care services. He specializes in modern cataract surgery and managing complex eye conditions, ensuring clear vision for his patients in Ambikapur.</p>
      ...
      <div class="col-lg-7">
        <div class="dp-profile-card">
          ...
          <div class="dp-expertise-grid">
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Phaco Cataract Surgery</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Glaucoma Management</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Diabetic Retinopathy</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Refractive Errors</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Eye Trauma</span>
          </div>
          ...
          <div class="dp-qual-box">
            ...
            <ul class="dp-qual-list">
                ...
                <li>Consultant Ophthalmologist</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-5">
        <div class="dp-sticky-sidebar">
          ...
          <div class="dp-book-card">
            ...
            <p class="dp-book-sub">Schedule a consultation with Dr. Akshaya Goyal. Our coordinator will reach out to confirm.</p>
            <form id="detailed-booking-form" class="appointment-form">
              <input type="hidden" id="book-dept" value="ophthalmology">
              <input type="hidden" id="book-doc" value="Dr. Akshaya Goyal">
              <div class="mb-3">
