...
<head>
  ...
  <title>Dr. Shailesh Gupta | Best Cardiology & Internal Medicine Specialist in Ambikapur | Sankalp Hospital</title>
  <meta name="description" content="Consult Dr. Shailesh Gupta, MBBS, MD (Medicine) | Senior Physician & Heart Specialist at Sankalp Hospital in Ambikapur. Dr. Shailesh Gupta is a highly experienced Physician and Cardiologist at Sankalp Hospital. With over 15 years of clinical practice, he specializes in managing complex medical conditions, particularly heart disease, hypertension, and metabolic disorders like diabetes.">
  ...
  <div class="container">
    ...
    <div class="dp-breadcrumb">
      <div class="dp-breadcrumb-list">
        ...
        <span class="sep"><i class="fas fa-chevron-right"></i></span>
        <span class="current">Dr. Shailesh Gupta</span>
      </div>
    </div>
      ...
      <div class="col-lg-4 col-md-5">
        <div class="dp-photo-wrapper">
          <div class="dp-photo-card">
            <img src="/images/shailesh-gupta.jpg" alt="Dr. Shailesh Gupta" onerror="this.src='/images/doc1.png'">
            <span class="dp-photo-badge"><i class="fas fa-award"></i> 15+ Years Exp</span>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-8 col-md-7">
        <div class="dp-hero-content">
          <span class="dp-specialty-tag">
            <i class="fas fa-stethoscope"></i> Cardiology &amp; Internal Medicine
          </span>
          <h1 class="dp-hero-name">Dr. Shailesh Gupta</h1>
          <p class="dp-hero-degrees">MBBS, MD (Medicine) | Senior Physician &amp; Heart Specialist</p>
          <p class="dp-hero-bio">Dr. Shailesh Gupta is a highly experienced Physician and Cardiologist at Sankalp Hospital. With over 15 years of clinical practice, he specializes in managing complex medical conditions, particularly heart disease, hypertension, and metabolic disorders like diabetes.</p>
    ...
    <div class="row g-4 g-lg-5">
      ...
      <div class="col-lg-7">
        <div class="dp-profile-card">
          ...
          <h2 class="dp-section-title">About Dr. Shailesh Gupta</h2>
          <p class="dp-profile-text">Dr. Shailesh provides comprehensive care for heart patients, including management of stable angina, heart failure, and complex arrhythmias. He also manages chronic lifestyle diseases like hypertension and diabetes, ensuring his patients live long and healthy lives.</p>
          ...
          <div class="dp-expertise-grid">
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Heart Disease</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Hypertension</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Diabetes Management</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> General Medicine</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Preventive Cardiology</span>
          </div>
          ...
          <div class="dp-qual-box">
            ...
            <ul class="dp-qual-list">
                <li>MBBS</li>
                <li>MD (Medicine)</li>
                <li>Senior Physician &amp; Heart Specialist</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-5">
        <div class="dp-sticky-sidebar">
          ...
          <div class="dp-book-card">
            ...
            <p class="dp-book-sub">Schedule a consultation with Dr. Shailesh Gupta. Our coordinator will reach out to confirm.</p>
            <form id="detailed-booking-form" class="appointment-form">
              <input type="hidden" id="book-dept" value="cardiology">
              <input type="hidden" id="book-doc" value="Dr. Shailesh Gupta">
              <div class="mb-3">
