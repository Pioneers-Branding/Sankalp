...
<?php include_once __DIR__ . '/../includes/analytics.php'; ?>
  ...
  <title>Dr. Yuvan Prasannaa | Best Anaesthesiology Specialist in Ambikapur | Sankalp Hospital</title>
  <meta name="description" content="Consult Dr. Yuvan Prasannaa, MBBS, MD (Anaesthesiology) | Consultant Anaesthesiologist at Sankalp Hospital in Ambikapur. Dr. Yuvan Prasannaa is a Senior Consultant Anaesthesiologist at Sankalp Hospital with over 10 years of experience. He specializes in administering safe anesthesia for complex surgical procedures and intensive pain management.">
  ...
  <div class="container">
    ...
    <div class="dp-breadcrumb">
      <div class="dp-breadcrumb-list">
        ...
        <span class="sep"><i class="fas fa-chevron-right"></i></span>
        <span class="current">Dr. Yuvan Prasannaa</span>
      </div>
    </div>
      ...
      <div class="col-lg-4 col-md-5">
        <div class="dp-photo-wrapper">
          <div class="dp-photo-card">
            <img src="/images/yuvan.jpg" alt="Dr. Yuvan Prasannaa" onerror="this.src='/images/doc1.png'">
      ...
      <div class="col-lg-8 col-md-7">
        <div class="dp-hero-content">
          <span class="dp-specialty-tag">
            <i class="fas fa-stethoscope"></i> Anaesthesiology
          </span>
          <h1 class="dp-hero-name">Dr. Yuvan Prasannaa</h1>
          <p class="dp-hero-degrees">MBBS, MD (Anaesthesiology) | Consultant Anaesthesiologist</p>
          <p class="dp-hero-bio">Dr. Yuvan Prasannaa is a Senior Consultant Anaesthesiologist at Sankalp Hospital with over 10 years of experience. He specializes in administering safe anesthesia for complex surgical procedures and intensive pain management.</p>
    ...
    <div class="row g-4 g-lg-5">
      ...
      <div class="col-lg-7">
        <div class="dp-profile-card">
          ...
          <h2 class="dp-section-title">About Dr. Yuvan Prasannaa</h2>
          <p class="dp-profile-text">With a profound background in critical care and anesthesiology, Dr. Yuvan Prasannaa ensures optimal patient safety during pre-operative and post-operative phases. His expertise spans regional, general, and pediatric anesthesia. He is an integral part of the surgical team, closely monitoring patient vitals and managing post-surgical pain to facilitate smooth recoveries.</p>
          ...
          <div class="dp-expertise-grid">
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> General &amp; Regional Anaesthesia</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Post-Operative Pain Management</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Critical Care &amp; ICU</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Pediatric Anaesthesia</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Trauma Resuscitation</span>
          </div>
          ...
          <div class="dp-qual-box">
            ...
            <ul class="dp-qual-list">
                ...
                <li>Consultant Anaesthesiologist</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-5">
        <div class="dp-sticky-sidebar">
          ...
          <div class="dp-book-card">
            ...
            <p class="dp-book-sub">Schedule a consultation with Dr. Yuvan Prasannaa. Our coordinator will reach out to confirm.</p>
            <form id="detailed-booking-form" class="appointment-form">
              <input type="hidden" id="book-dept" value="anaesthesiology">
              <input type="hidden" id="book-doc" value="Dr. Yuvan Prasannaa">
              <div class="mb-3">
