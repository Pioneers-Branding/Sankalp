...
<head>
  ...
  <title>Dr. Rimsha Lakesh Sahu | Best Nutrition & Dietetics Specialist in Ambikapur | Sankalp Hospital</title>
  <meta name="description" content="Consult Dr. Rimsha Lakesh Sahu, M.Sc. (Nutrition & Dietetics) | Consultant Nutritionist at Sankalp Hospital in Ambikapur. Dr. Rimsha Lakesh Sahu is a highly skilled Nutritionist at Sankalp Hospital, helping patients achieve their health goals through personalized diet plans.">
  ...
  <div class="container">
    ...
    <div class="dp-breadcrumb">
      <div class="dp-breadcrumb-list">
        ...
        <span class="sep"><i class="fas fa-chevron-right"></i></span>
        <span class="current">Dr. Rimsha Lakesh Sahu</span>
      </div>
    </div>
      ...
      <div class="col-lg-4 col-md-5">
        <div class="dp-photo-wrapper">
          <div class="dp-photo-card">
            <img src="/images/rimsha-sahu.jpg" alt="Dr. Rimsha Lakesh Sahu" onerror="this.src='/images/doc1.png'">
      ...
      <div class="col-lg-8 col-md-7">
        <div class="dp-hero-content">
          <span class="dp-specialty-tag">
            <i class="fas fa-stethoscope"></i> Nutrition &amp; Dietetics
          </span>
          <h1 class="dp-hero-name">Dr. Rimsha Lakesh Sahu</h1>
          <p class="dp-hero-degrees">M.Sc. (Nutrition &amp; Dietetics) | Consultant Nutritionist</p>
          <p class="dp-hero-bio">Dr. Rimsha Lakesh Sahu is a highly skilled Nutritionist at Sankalp Hospital, helping patients achieve their health goals through personalized diet plans.</p>
    ...
    <div class="row g-4 g-lg-5">
      ...
      <div class="col-lg-7">
        <div class="dp-profile-card">
          ...
          <h2 class="dp-section-title">About Dr. Rimsha Lakesh Sahu</h2>
          <p class="dp-profile-text">Dr. Rimsha Lakesh Sahu is a highly skilled Nutritionist at Sankalp Hospital, helping patients achieve their health goals through personalized diet plans. She specializes in clinical nutrition, helping patients manage chronic diseases like diabetes and hypertension through lifestyle modifications. She works closely with patients to create sustainable eating habits that promote healing and long-term wellness.</p>
          ...
          <div class="dp-expertise-grid">
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Weight Loss Plans</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Diabetic Diet</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Therapeutic Nutrition</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Child Nutrition</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Lifestyle Coaching</span>
          </div>
      ...
      <div class="col-lg-5">
        <div class="dp-sticky-sidebar">
          ...
          <div class="dp-book-card">
            ...
            <p class="dp-book-sub">Schedule a consultation with Dr. Rimsha Lakesh Sahu. Our coordinator will reach out to confirm.</p>
            <form id="detailed-booking-form" class="appointment-form">
              <input type="hidden" id="book-dept" value="nutrition">
              <input type="hidden" id="book-doc" value="Dr. Rimsha Lakesh Sahu">
              <div class="mb-3">
