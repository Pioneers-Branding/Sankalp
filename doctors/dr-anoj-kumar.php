...
<?php include_once __DIR__ . '/../includes/analytics.php'; ?>
  ...
  <title>Dr. Anoj Kumar | Best Anaesthesiology Specialist in Ambikapur | Sankalp Hospital</title>
  <meta name="description" content="Consult Dr. Anoj Kumar, MBBS, DNB (Anaesthesiology) | Consultant Anaesthesiologist at Sankalp Hospital in Ambikapur. Dr. Anoj Kumar is a dedicated Consultant Anaesthesiologist, proficient in advanced airway management and regional anesthesia for high-risk surgical patients.">
  ...
  <div class="container">
    ...
    <div class="dp-breadcrumb">
      <div class="dp-breadcrumb-list">
        ...
        <span class="sep"><i class="fas fa-chevron-right"></i></span>
        <span class="current">Dr. Anoj Kumar</span>
      </div>
    </div>
    ...
    <div class="row align-items-center g-4 g-lg-5 mt-2">
      ...
      <div class="col-lg-8 col-md-7">
        <div class="dp-hero-content">
          ...
          <h1 class="dp-hero-name">Dr. Anoj Kumar</h1>
          <p class="dp-hero-degrees">MBBS, DNB (Anaesthesiology) | Consultant Anaesthesiologist</p>
          <p class="dp-hero-bio">Dr. Anoj Kumar is a dedicated Consultant Anaesthesiologist, proficient in advanced airway management and regional anesthesia for high-risk surgical patients.</p>
    ...
    <div class="row g-4 g-lg-5">
      ...
      <div class="col-lg-7">
        <div class="dp-profile-card">
          ...
          <h2 class="dp-section-title">About Dr. Anoj Kumar</h2>
          <p class="dp-profile-text">Dr. Kumar specializes in providing safe and effective anesthesia care across various surgical specialties, including orthopedics, general surgery, and obstetrics. He is particularly skilled in nerve blocks and epidural analgesia, focusing on minimizing post-operative pain and enhancing patient comfort. His vigilant approach ensures the highest safety standards in the operating theater.</p>
          ...
          <div class="dp-expertise-grid">
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Advanced Airway Management</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Regional &amp; Epidural Anaesthesia</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> High-Risk Surgical Anaesthesia</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Pain Management</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Obstetric Anaesthesia</span>
          </div>
      ...
      <div class="col-lg-5">
        <div class="dp-sticky-sidebar">
          ...
          <div class="dp-book-card">
            ...
            <p class="dp-book-sub">Schedule a consultation with Dr. Anoj Kumar. Our coordinator will reach out to confirm.</p>
            <form id="detailed-booking-form" class="appointment-form">
              <input type="hidden" id="book-dept" value="anaesthesiology">
              <input type="hidden" id="book-doc" value="Dr. Anoj Kumar">
              <div class="mb-3">
