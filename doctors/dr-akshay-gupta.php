  ...
  <div class="container">
    ...
    <div class="dp-breadcrumb">
      <div class="dp-breadcrumb-list">
        ...
        <span class="sep"><i class="fas fa-chevron-right"></i></span>
        <span class="current">Dr. Akshay Gupta</span>
      </div>
    </div>
      ...
      <div class="col-lg-4 col-md-5">
        <div class="dp-photo-wrapper">
          <div class="dp-photo-card">
            <img src="/images/akshay-gupta.jpg" alt="Dr. Akshay Gupta" onerror="this.src='/images/doc1.png'">
            <span class="dp-photo-badge"><i class="fas fa-award"></i> 5+ Years Exp</span>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-8 col-md-7">
        <div class="dp-hero-content">
          <span class="dp-specialty-tag">
            <i class="fas fa-stethoscope"></i> Rheumatology &amp; Internal Medicine
          </span>
          <h1 class="dp-hero-name">Dr. Akshay Gupta</h1>
          <p class="dp-hero-degrees">MD (Medicine) | Consultant Physician &amp; Rheumatologist</p>
          <p class="dp-hero-bio">Dr. Akshay Gupta is a Consultant Physician and Rheumatologist with expertise in Internal Medicine, autoimmune diseases, arthritis, and complex medical disorders. He completed his MBBS from Vardhman Mahavir Medical College &amp; Safdarjung Hospital and MD (Medicine) from Dr. Ram Manohar Lohia Hospital, New Delhi. He is recognized as the first and only rheumatology specialist serving the Surguja region.</p>
    ...
    <div class="row g-4 g-lg-5">
      ...
      <div class="col-lg-7">
        <div class="dp-profile-card">
          ...
          <h2 class="dp-section-title">About Dr. Akshay Gupta</h2>
          <p class="dp-profile-text">Dr. Akshay Gupta is a Consultant Physician and Rheumatologist at Sankalp Hospital. He completed his MBBS from Vardhman Mahavir Medical College &amp; Safdarjung Hospital and MD from RML Hospital, New Delhi. He is recognized as the first and only rheumatology specialist serving the Surguja region.</p>
          ...
          <div class="dp-expertise-grid">
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Rheumatology</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Rheumatoid Arthritis</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Ankylosing Spondylitis</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Lupus (SLE)</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Psoriatic Arthritis</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Gout</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Vasculitis</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Osteoporosis</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Diabetes &amp; Hypertension</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> General Internal Medicine</span>
          </div>
          ...
          <div class="dp-qual-box">
            ...
            <ul class="dp-qual-list">
                <li>MD (Medicine)</li>
                <li>Consultant Physician &amp; Rheumatologist</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-5">
        <div class="dp-sticky-sidebar">
          ...
          <div class="dp-book-card">
            ...
            <p class="dp-book-sub">Schedule a consultation with Dr. Akshay Gupta. Our coordinator will reach out to confirm.</p>
            <form id="detailed-booking-form" class="appointment-form">
              <input type="hidden" id="book-dept" value="rheumatology">
              <input type="hidden" id="book-doc" value="Dr. Akshay Gupta">
              <div class="mb-3">
