...
<head>
  ...
  <title>Dr. Usha Armo | Best ENT (Otolaryngology) Specialist in Ambikapur | Sankalp Hospital</title>
  <meta name="description" content="Consult Dr. Usha Armo, MBBS, MS (ENT) | Senior ENT Consultant at Sankalp Hospital in Ambikapur. Dr. Usha Armo is a dedicated ENT Specialist at Sankalp Hospital with over 12 years of clinical experience. She is highly proficient in managing both medical and surgical conditions of the ear, nose, and throat. Her expertise in endoscopy and microsurgery has helped many patients find relief from chronic ENT problems.">
  ...
  <div class="container">
    ...
    <div class="dp-breadcrumb">
      <div class="dp-breadcrumb-list">
        ...
        <span class="sep"><i class="fas fa-chevron-right"></i></span>
        <span class="current">Dr. Usha Armo</span>
      </div>
    </div>
      ...
      <div class="col-lg-4 col-md-5">
        <div class="dp-photo-wrapper">
          <div class="dp-photo-card">
            <img src="/images/usha-armo.jpg" alt="Dr. Usha Armo" onerror="this.src='/images/doc1.png'">
            <span class="dp-photo-badge"><i class="fas fa-award"></i> 12+ Years Exp</span>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-8 col-md-7">
        <div class="dp-hero-content">
          <span class="dp-specialty-tag">
            <i class="fas fa-stethoscope"></i> ENT (Otolaryngology)
          </span>
          <h1 class="dp-hero-name">Dr. Usha Armo</h1>
          <p class="dp-hero-degrees">MBBS, MS (ENT) | Senior ENT Consultant</p>
          <p class="dp-hero-bio">Dr. Usha Armo is a dedicated ENT Specialist at Sankalp Hospital with over 12 years of clinical experience. She is highly proficient in managing both medical and surgical conditions of the ear, nose, and throat. Her expertise in endoscopy and microsurgery has helped many patients find relief from chronic ENT problems.</p>
      ...
      <div class="col-lg-7">
        <div class="dp-profile-card">
          ...
          <div class="dp-expertise-grid">
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Sinusitis Treatment</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Tympanoplasty</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Hearing Loss</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Tonsillectomy</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Nasal Endoscopy</span>
          </div>
      ...
      <div class="col-lg-5">
        <div class="dp-sticky-sidebar">
          ...
          <div class="dp-book-card">
            ...
            <p class="dp-book-sub">Schedule a consultation with Dr. Usha Armo. Our coordinator will reach out to confirm.</p>
            <form id="detailed-booking-form" class="appointment-form">
              <input type="hidden" id="book-dept" value="ent">
              <input type="hidden" id="book-doc" value="Dr. Usha Armo">
              <div class="mb-3">
