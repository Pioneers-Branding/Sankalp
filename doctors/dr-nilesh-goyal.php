...
<head>
  ...
  <title>Dr. Nilesh Goyal | Best General & Laparoscopic Surgery Specialist in Ambikapur | Sankalp Hospital</title>
  <meta name="description" content="Consult Dr. Nilesh Goyal, MBBS, MS (General Surgery) | Consultant General & Laparoscopic Surgeon at Sankalp Hospital in Ambikapur. Dr. Nilesh Goyal is an expert General and Laparoscopic Surgeon at Sankalp Hospital. He specializes in minimally invasive surgeries, helping patients recover faster with less pain. He has extensive experience in performing complex abdominal surgeries and trauma management.">
  ...
  <div class="container">
    ...
    <div class="dp-breadcrumb">
      <div class="dp-breadcrumb-list">
        ...
        <span class="sep"><i class="fas fa-chevron-right"></i></span>
        <span class="current">Dr. Nilesh Goyal</span>
      </div>
    </div>
      ...
      <div class="col-lg-4 col-md-5">
        <div class="dp-photo-wrapper">
          <div class="dp-photo-card">
            <img src="/images/nilesh-goyal.jpg" alt="Dr. Nilesh Goyal" onerror="this.src='/images/doc1.png'">
      ...
      <div class="col-lg-8 col-md-7">
        <div class="dp-hero-content">
          <span class="dp-specialty-tag">
            <i class="fas fa-stethoscope"></i> General &amp; Laparoscopic Surgery
          </span>
          <h1 class="dp-hero-name">Dr. Nilesh Goyal</h1>
          <p class="dp-hero-degrees">MBBS, MS (General Surgery) | Consultant General &amp; Laparoscopic Surgeon</p>
          <p class="dp-hero-bio">Dr. Nilesh Goyal is an expert General and Laparoscopic Surgeon at Sankalp Hospital. He specializes in minimally invasive surgeries, helping patients recover faster with less pain. He has extensive experience in performing complex abdominal surgeries and trauma management.</p>
    ...
    <div class="row g-4 g-lg-5">
      ...
      <div class="col-lg-7">
        <div class="dp-profile-card">
          ...
          <h2 class="dp-section-title">About Dr. Nilesh Goyal</h2>
          <p class="dp-profile-text">Dr. Nilesh is committed to providing high-quality surgical treatment with a focus on patient safety and comfort. His expertise in laparoscopic surgery ensures smaller incisions, less post-operative pain, and a quicker return to daily activities for his patients.</p>
          ...
          <div class="dp-expertise-grid">
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Laparoscopic Gallbladder Surgery</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Hernia Repair</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Appendectomy</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Abdominal Surgery</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Trauma Surgery</span>
          </div>
          ...
          <div class="dp-qual-box">
            ...
            <ul class="dp-qual-list">
                ...
                <li>Consultant General &amp; Laparoscopic Surgeon</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-5">
        <div class="dp-sticky-sidebar">
          ...
          <div class="dp-book-card">
            ...
            <p class="dp-book-sub">Schedule a consultation with Dr. Nilesh Goyal. Our coordinator will reach out to confirm.</p>
            <form id="detailed-booking-form" class="appointment-form">
              <input type="hidden" id="book-dept" value="general">
              <input type="hidden" id="book-doc" value="Dr. Nilesh Goyal">
              <div class="mb-3">
