...
<?php include_once __DIR__ . '/../includes/analytics.php'; ?>
  ...
  <title>Dr. Megha Goyal | Best Neonatology & Pediatrics Specialist in Ambikapur | Sankalp Hospital</title>
  <meta name="description" content="Consult Dr. Megha Goyal, MBBS, MD (Pediatrics) | Consultant Neonatologist at Sankalp Hospital in Ambikapur. Dr. Megha Goyal is a dedicated Neonatologist at Sankalp Hospital, specializing in the care of newborns and premature infants. Her expertise in the Neonatal Intensive Care Unit (NICU) has saved many lives, providing the highest standard of care for the most vulnerable patients.">
  ...
  <div class="container">
    ...
    <div class="dp-breadcrumb">
      <div class="dp-breadcrumb-list">
        ...
        <span class="sep"><i class="fas fa-chevron-right"></i></span>
        <span class="current">Dr. Megha Goyal</span>
      </div>
    </div>
      ...
      <div class="col-lg-4 col-md-5">
        <div class="dp-photo-wrapper">
          <div class="dp-photo-card">
            <img src="/images/megha-goyal.jpg" alt="Dr. Megha Goyal" onerror="this.src='/images/doc1.png'">
            <span class="dp-photo-badge"><i class="fas fa-award"></i> 7+ Years Exp</span>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-8 col-md-7">
        <div class="dp-hero-content">
          <span class="dp-specialty-tag">
            <i class="fas fa-stethoscope"></i> Neonatology &amp; Pediatrics
          </span>
          <h1 class="dp-hero-name">Dr. Megha Goyal</h1>
          <p class="dp-hero-degrees">MBBS, MD (Pediatrics) | Consultant Neonatologist</p>
          <p class="dp-hero-bio">Dr. Megha Goyal is a dedicated Neonatologist at Sankalp Hospital, specializing in the care of newborns and premature infants. Her expertise in the Neonatal Intensive Care Unit (NICU) has saved many lives, providing the highest standard of care for the most vulnerable patients.</p>
    ...
    <div class="row g-4 g-lg-5">
      ...
      <div class="col-lg-7">
        <div class="dp-profile-card">
          ...
          <h2 class="dp-section-title">About Dr. Megha Goyal</h2>
          <p class="dp-profile-text">Dr. Megha&#039;s dedication to neonatal health ensures that every baby born at Sankalp Hospital has immediate access to expert care if complications arise. She also provides regular pediatric consultations, guiding parents through the crucial early years of their child&#039;s development.</p>
          ...
          <div class="dp-expertise-grid">
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Newborn Care</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> NICU Specialist</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Premature Baby Care</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Pediatric Emergencies</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Childhood Immunization</span>
          </div>
          ...
          <div class="dp-qual-box">
            ...
            <ul class="dp-qual-list">
                <li>MBBS</li>
                <li>MD (Pediatrics)</li>
                <li>Consultant Neonatologist</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-5">
        <div class="dp-sticky-sidebar">
          ...
          <div class="dp-book-card">
            ...
            <p class="dp-book-sub">Schedule a consultation with Dr. Megha Goyal. Our coordinator will reach out to confirm.</p>
            <form id="detailed-booking-form" class="appointment-form">
              <input type="hidden" id="book-dept" value="neonatology">
              <input type="hidden" id="book-doc" value="Dr. Megha Goyal">
              <div class="mb-3">
