...
<head>
  ...
  <title>Dr. Suneedh Gupta | Best Oral & Maxillofacial Surgery Specialist in Ambikapur | Sankalp Hospital</title>
  <meta name="description" content="Consult Dr. Suneedh Gupta, BDS, MDS (Oral & Maxillofacial Surgery) | Consultant Oral & Maxillofacial Surgeon at Sankalp Hospital in Ambikapur. Dr. Suneedh Gupta is a highly skilled Oral & Maxillofacial Surgeon at Sankalp Hospital. He specializes in surgeries of the face, mouth, and jaws, including facial trauma management, oral pathology, and complex tooth extractions. He is dedicated to restoring facial function and aesthetics for his patients.">
  ...
  <div class="container">
    ...
    <div class="dp-breadcrumb">
      <div class="dp-breadcrumb-list">
        ...
        <span class="sep"><i class="fas fa-chevron-right"></i></span>
        <span class="current">Dr. Suneedh Gupta</span>
      </div>
    </div>
      ...
      <div class="col-lg-4 col-md-5">
        <div class="dp-photo-wrapper">
          <div class="dp-photo-card">
            <img src="/images/suneedh-gupta.jpg" alt="Dr. Suneedh Gupta" onerror="this.src='/images/doc1.png'">
      ...
      <div class="col-lg-8 col-md-7">
        <div class="dp-hero-content">
          <span class="dp-specialty-tag">
            <i class="fas fa-stethoscope"></i> Oral &amp; Maxillofacial Surgery
          </span>
          <h1 class="dp-hero-name">Dr. Suneedh Gupta</h1>
          <p class="dp-hero-degrees">BDS, MDS (Oral &amp; Maxillofacial Surgery) | Consultant Oral &amp; Maxillofacial Surgeon</p>
          <p class="dp-hero-bio">Dr. Suneedh Gupta is a highly skilled Oral &amp; Maxillofacial Surgeon at Sankalp Hospital. He specializes in surgeries of the face, mouth, and jaws, including facial trauma management, oral pathology, and complex tooth extractions. He is dedicated to restoring facial function and aesthetics for his patients.</p>
    ...
    <div class="row g-4 g-lg-5">
      ...
      <div class="col-lg-7">
        <div class="dp-profile-card">
          ...
          <h2 class="dp-section-title">About Dr. Suneedh Gupta</h2>
          <p class="dp-profile-text">Dr. Suneedh is known for his surgical precision in treating facial fractures and performing complex jaw surgeries. He works closely with other specialists at Sankalp Hospital to provide comprehensive care for trauma victims and patients with oral diseases.</p>
          ...
          <div class="dp-expertise-grid">
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Facial Trauma Surgery</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Jaw Realignment</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Oral Cancer Screening</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Complex Extractions</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Dental Implants</span>
          </div>
          ...
          <div class="dp-qual-box">
            ...
            <ul class="dp-qual-list">
                ...
                <li>Consultant Oral &amp; Maxillofacial Surgeon</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-5">
        <div class="dp-sticky-sidebar">
          ...
          <div class="dp-book-card">
            ...
            <p class="dp-book-sub">Schedule a consultation with Dr. Suneedh Gupta. Our coordinator will reach out to confirm.</p>
            <form id="detailed-booking-form" class="appointment-form">
              <input type="hidden" id="book-dept" value="oral">
              <input type="hidden" id="book-doc" value="Dr. Suneedh Gupta">
              <div class="mb-3">
