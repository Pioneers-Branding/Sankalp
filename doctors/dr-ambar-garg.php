...
<?php include_once __DIR__ . '/../includes/analytics.php'; ?>
  ...
  <title>Dr. Ambar Garg | Best Haematology Specialist in Ambikapur | Sankalp Hospital</title>
  <meta name="description" content="Consult Dr. Ambar Garg, MBBS, MS (Haematology) | Consultant Haematologist at Sankalp Hospital in Ambikapur. Dr. Ambar Garg is a leading Consultant Haematologist with a focus on diagnosing and treating blood disorders, including anemias, bleeding disorders, and hematological malignancies.">
  ...
  <div class="container">
    ...
    <div class="dp-breadcrumb">
      <div class="dp-breadcrumb-list">
        ...
        <span class="sep"><i class="fas fa-chevron-right"></i></span>
        <span class="current">Dr. Ambar Garg</span>
      </div>
    </div>
      ...
      <div class="col-lg-4 col-md-5">
        <div class="dp-photo-wrapper">
          <div class="dp-photo-card">
            <img src="/images/ambar-garg.png" alt="Dr. Ambar Garg" onerror="this.src='/images/doc1.png'">
      ...
      <div class="col-lg-8 col-md-7">
        <div class="dp-hero-content">
          <span class="dp-specialty-tag">
            <i class="fas fa-stethoscope"></i> Haematology
          </span>
          <h1 class="dp-hero-name">Dr. Ambar Garg</h1>
          <p class="dp-hero-degrees">MBBS, MS (Haematology) | Consultant Haematologist</p>
          <p class="dp-hero-bio">Dr. Ambar Garg is a leading Consultant Haematologist with a focus on diagnosing and treating blood disorders, including anemias, bleeding disorders, and hematological malignancies.</p>
    ...
    <div class="row g-4 g-lg-5">
      ...
      <div class="col-lg-7">
        <div class="dp-profile-card">
          ...
          <h2 class="dp-section-title">About Dr. Ambar Garg</h2>
          <p class="dp-profile-text">Dr. Garg brings comprehensive expertise in clinical haematology and bone marrow disorders. He is deeply involved in managing complex cases of leukemia, lymphoma, and multiple myeloma. With a compassionate approach, Dr. Garg ensures that patients receive the most advanced and personalized therapeutic regimens available for both benign and malignant blood conditions.</p>
          ...
          <div class="dp-expertise-grid">
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Leukemia &amp; Lymphoma</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Anemia &amp; Bleeding Disorders</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Multiple Myeloma</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Coagulation Disorders</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Bone Marrow Evaluation</span>
          </div>
          ...
          <div class="dp-qual-box">
            ...
            <ul class="dp-qual-list">
                <li>MBBS</li>
                <li>MS (Haematology)</li>
                <li>Consultant Haematologist</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-5">
        <div class="dp-sticky-sidebar">
          ...
          <div class="dp-book-card">
            ...
            <p class="dp-book-sub">Schedule a consultation with Dr. Ambar Garg. Our coordinator will reach out to confirm.</p>
            <form id="detailed-booking-form" class="appointment-form">
              <input type="hidden" id="book-dept" value="haematology">
              <input type="hidden" id="book-doc" value="Dr. Ambar Garg">
              <div class="mb-3">
