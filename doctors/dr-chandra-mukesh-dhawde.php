...
<?php include_once __DIR__ . '/../includes/analytics.php'; ?>
  ...
  <title>Dr. Chandra Mukesh Dhawde | Best General & Laparoscopic Surgery Specialist in Ambikapur | Sankalp Hospital</title>
  <meta name="description" content="Consult Dr. Chandra Mukesh Dhawde, MBBS, MS - Laparoscopic Surgeon at Sankalp Hospital in Ambikapur. Expert in laparoscopic keyhole surgery, hernia treatment, and general abdominal surgeries.">
  ...
  <div class="container">
    ...
    <div class="dp-breadcrumb">
      <div class="dp-breadcrumb-list">
        ...
        <span class="sep"><i class="fas fa-chevron-right"></i></span>
        <span class="current">Dr. Chandra Mukesh Dhawde</span>
      </div>
    </div>
    ...
    <div class="row align-items-center g-4 g-lg-5 mt-2">
      ...
      <div class="col-lg-4 col-md-5">
        <div class="dp-photo-wrapper">
          <div class="dp-photo-card">
            <img src="/images/chandra-dhawde.jpg" alt="Dr. Chandra Mukesh Dhawde" onerror="this.src='/images/doc1.png'">
      ...
      <div class="col-lg-8 col-md-7">
        <div class="dp-hero-content">
          ...
          <h1 class="dp-hero-name">Dr. Chandra Mukesh Dhawde</h1>
          <p class="dp-hero-degrees">MBBS, MS - Laparoscopic Surgeon</p>
          <p class="dp-hero-bio">Expert in laparoscopic keyhole surgery, hernia treatment, and general abdominal surgeries.</p>
    ...
    <div class="row g-4 g-lg-5">
      ...
      <div class="col-lg-7">
        <div class="dp-profile-card">
          ...
          <h2 class="dp-section-title">About Dr. Chandra Mukesh Dhawde</h2>
          <p class="dp-profile-text">Dr. Chandra Mukesh Dhawde is an expert Laparoscopic and General Surgeon at Sankalp Hospital. He specializes in minimally invasive keyhole procedures, abdominal wall reconstructions, and hernia repairs. He focuses on modern surgical methods that reduce post-operative recovery times and pain.</p>
          ...
          <div class="dp-expertise-grid">
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Laparoscopic Keyhole Surgery</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Hernia Reconstructions</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Appendectomy &amp; Cholecystectomy</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Abdominal Trauma Care</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Thyroid &amp; Breast Surgeries</span>
          </div>
      ...
      <div class="col-lg-5">
        <div class="dp-sticky-sidebar">
          ...
          <div class="dp-book-card">
            ...
            <p class="dp-book-sub">Schedule a consultation with Dr. Chandra Mukesh Dhawde. Our coordinator will reach out to confirm.</p>
            <form id="detailed-booking-form" class="appointment-form">
              <input type="hidden" id="book-dept" value="general">
              <input type="hidden" id="book-doc" value="Dr. Chandra Mukesh Dhawde">
              <div class="mb-3">
