...
<?php include_once __DIR__ . '/../includes/analytics.php'; ?>
  ...
  <title>Dr. Chetan Chaturvedi | Best Cardiology Specialist in Ambikapur | Sankalp Hospital</title>
  <meta name="description" content="Consult Dr. Chetan Chaturvedi, MBBS, DNB (Cardiology) | Consultant Cardiologist at Sankalp Hospital in Ambikapur. Dr. Chetan Chaturvedi is a leading Consultant Cardiologist specializing in interventional cardiology, echocardiography, and the comprehensive management of cardiovascular diseases.">
  ...
  <div class="container">
    ...
    <div class="dp-breadcrumb">
      <div class="dp-breadcrumb-list">
        ...
        <span class="sep"><i class="fas fa-chevron-right"></i></span>
        <span class="current">Dr. Chetan Chaturvedi</span>
      </div>
    </div>
      ...
      <div class="col-lg-4 col-md-5">
        <div class="dp-photo-wrapper">
          <div class="dp-photo-card">
            <img src="/images/chetan-chaturvedi.png" alt="Dr. Chetan Chaturvedi" onerror="this.src='/images/doc1.png'">
      ...
      <div class="col-lg-8 col-md-7">
        <div class="dp-hero-content">
          <span class="dp-specialty-tag">
            <i class="fas fa-stethoscope"></i> Cardiology
          </span>
          <h1 class="dp-hero-name">Dr. Chetan Chaturvedi</h1>
          <p class="dp-hero-degrees">MBBS, DNB (Cardiology) | Consultant Cardiologist</p>
          <p class="dp-hero-bio">Dr. Chetan Chaturvedi is a leading Consultant Cardiologist specializing in interventional cardiology, echocardiography, and the comprehensive management of cardiovascular diseases.</p>
    ...
    <div class="row g-4 g-lg-5">
      ...
      <div class="col-lg-7">
        <div class="dp-profile-card">
          ...
          <h2 class="dp-section-title">About Dr. Chetan Chaturvedi</h2>
          <p class="dp-profile-text">Dr. Chaturvedi is dedicated to the prevention, diagnosis, and treatment of heart conditions. His clinical focus includes managing acute myocardial infarctions, heart failure, and complex arrhythmias. He is highly proficient in performing diagnostic angiograms and echocardiograms. His patient-first philosophy ensures comprehensive cardiovascular care aimed at long-term heart health.</p>
          ...
          <div class="dp-expertise-grid">
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Interventional Cardiology</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Echocardiography (2D Echo)</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Heart Failure Management</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Hypertension &amp; Lipid Management</span>
      ...
      <div class="col-lg-5">
        <div class="dp-sticky-sidebar">
          ...
          <div class="dp-book-card">
            ...
            <p class="dp-book-sub">Schedule a consultation with Dr. Chetan Chaturvedi. Our coordinator will reach out to confirm.</p>
            <form id="detailed-booking-form" class="appointment-form">
              <input type="hidden" id="book-dept" value="cardiology">
              <input type="hidden" id="book-doc" value="Dr. Chetan Chaturvedi">
              <div class="mb-3">
