...
<head>
  ...
  <title>Dr. Sanjay Goyal | Best Ophthalmology (Senior Specialist) Specialist in Ambikapur | Sankalp Hospital</title>
  <meta name="description" content="Consult Dr. Sanjay Goyal, MBBS, MS (Ophthalmology) | Founder & Senior Eye Surgeon at Sankalp Hospital in Ambikapur. Dr. Sanjay Goyal is the founder of Sankalp Hospital and a pioneer of modern ophthalmology in the Surguja region. With over 25 years of experience, he has performed thousands of successful eye surgeries and is dedicated to providing world-class vision care to the community.">
  ...
  <div class="container">
    ...
    <div class="dp-breadcrumb">
      <div class="dp-breadcrumb-list">
        ...
        <span class="sep"><i class="fas fa-chevron-right"></i></span>
        <span class="current">Dr. Sanjay Goyal</span>
      </div>
    </div>
      ...
      <div class="col-lg-4 col-md-5">
        <div class="dp-photo-wrapper">
          <div class="dp-photo-card">
            <img src="/images/sanjay-goyal.jpg" alt="Dr. Sanjay Goyal" onerror="this.src='/images/doc1.png'">
            <span class="dp-photo-badge"><i class="fas fa-award"></i> 25+ Years Exp</span>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-8 col-md-7">
        <div class="dp-hero-content">
          <span class="dp-specialty-tag">
            <i class="fas fa-stethoscope"></i> Ophthalmology (Senior Specialist)
          </span>
          <h1 class="dp-hero-name">Dr. Sanjay Goyal</h1>
          <p class="dp-hero-degrees">MBBS, MS (Ophthalmology) | Founder &amp; Senior Eye Surgeon</p>
          <p class="dp-hero-bio">Dr. Sanjay Goyal is the founder of Sankalp Hospital and a pioneer of modern ophthalmology in the Surguja region. With over 25 years of experience, he has performed thousands of successful eye surgeries and is dedicated to providing world-class vision care to the community.</p>
    ...
    <div class="row g-4 g-lg-5">
      ...
      <div class="col-lg-7">
        <div class="dp-profile-card">
          ...
          <h2 class="dp-section-title">About Dr. Sanjay Goyal</h2>
          <p class="dp-profile-text">Dr. Sanjay&#039;s vision for Sankalp Hospital was to provide world-class healthcare facilities to the people of Ambikapur at affordable costs. His expertise in complex ocular trauma and advanced cataract surgery makes him the most sought-after ophthalmologist in the region.</p>
          ...
          <div class="dp-expertise-grid">
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Micro-Incision Cataract Surgery</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Laser Eye Treatment</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Ocular Trauma</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Corneal Diseases</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Comprehensive Eye Care</span>
          </div>
          ...
          <div class="dp-qual-box">
            ...
            <ul class="dp-qual-list">
                ...
                <li>Founder &amp; Senior Eye Surgeon</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-5">
        <div class="dp-sticky-sidebar">
          ...
          <div class="dp-book-card">
            ...
            <p class="dp-book-sub">Schedule a consultation with Dr. Sanjay Goyal. Our coordinator will reach out to confirm.</p>
            <form id="detailed-booking-form" class="appointment-form">
              <input type="hidden" id="book-dept" value="ophthalmology">
              <input type="hidden" id="book-doc" value="Dr. Sanjay Goyal">
              <div class="mb-3">
