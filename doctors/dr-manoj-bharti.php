...
<head>
  ...
  <title>Dr. Manoj Bharti | Best Dentistry Specialist in Ambikapur | Sankalp Hospital</title>
  <meta name="description" content="Consult Dr. Manoj Bharti, BDS - Consultant Dentist at Sankalp Hospital in Ambikapur. Experienced Dentist providing comprehensive dental care, root canals, and cosmetic dental treatments.">
  ...
  <div class="container">
    ...
    <div class="dp-breadcrumb">
      <div class="dp-breadcrumb-list">
        ...
        <span class="sep"><i class="fas fa-chevron-right"></i></span>
        <span class="current">Dr. Manoj Bharti</span>
      </div>
    </div>
      ...
      <div class="col-lg-4 col-md-5">
        <div class="dp-photo-wrapper">
          <div class="dp-photo-card">
            <img src="/images/manoj-bharti.jpg" alt="Dr. Manoj Bharti" onerror="this.src='/images/doc1.png'">
      ...
      <div class="col-lg-8 col-md-7">
        <div class="dp-hero-content">
          <span class="dp-specialty-tag">
            <i class="fas fa-stethoscope"></i> Dentistry
          </span>
          <h1 class="dp-hero-name">Dr. Manoj Bharti</h1>
          <p class="dp-hero-degrees">BDS - Consultant Dentist</p>
          <p class="dp-hero-bio">Experienced Dentist providing comprehensive dental care, root canals, and cosmetic dental treatments.</p>
    ...
    <div class="row g-4 g-lg-5">
      ...
      <div class="col-lg-7">
        <div class="dp-profile-card">
          ...
          <h2 class="dp-section-title">About Dr. Manoj Bharti</h2>
          <p class="dp-profile-text">Dr. Manoj Bharti is an experienced Consultant Dentist at Sankalp Hospital. He provides a wide range of dental care services, from preventative dental checks and restorative fillings to root canals, crowns, bridges, and cosmetic smile designs, ensuring beautiful and healthy smiles.</p>
          ...
          <div class="dp-expertise-grid">
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Root Canal Treatment (RCT)</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Dental Crowns &amp; Bridges</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Cosmetic Dentistry</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Teeth Scaling &amp; Whitening</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Preventative Dental Care</span>
          </div>
      ...
      <div class="col-lg-5">
        <div class="dp-sticky-sidebar">
          ...
          <div class="dp-book-card">
            ...
            <p class="dp-book-sub">Schedule a consultation with Dr. Manoj Bharti. Our coordinator will reach out to confirm.</p>
            <form id="detailed-booking-form" class="appointment-form">
              <input type="hidden" id="book-dept" value="dentistry">
              <input type="hidden" id="book-doc" value="Dr. Manoj Bharti">
              <div class="mb-3">
