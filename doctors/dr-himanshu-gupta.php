...
<?php include_once __DIR__ . '/../includes/analytics.php'; ?>
  ...
  <title>Dr. Himanshu Gupta | Best Oncology Specialist in Ambikapur | Sankalp Hospital</title>
  <meta name="description" content="Consult Dr. Himanshu Gupta, MBBS, MD / DNB - Medical Oncology at Sankalp Hospital in Ambikapur. Cancer & Chemotherapy Specialist coordinating tumor chemotherapies and cancer screening packages.">
  ...
  <div class="container">
    ...
    <div class="dp-breadcrumb">
      <div class="dp-breadcrumb-list">
        ...
        <span class="sep"><i class="fas fa-chevron-right"></i></span>
        <span class="current">Dr. Himanshu Gupta</span>
      </div>
    </div>
      ...
      <div class="col-lg-4 col-md-5">
        <div class="dp-photo-wrapper">
          <div class="dp-photo-card">
            <img src="/images/himanshu-gupta.jpg" alt="Dr. Himanshu Gupta" onerror="this.src='/images/doc1.png'">
      ...
      <div class="col-lg-8 col-md-7">
        <div class="dp-hero-content">
          <span class="dp-specialty-tag">
            <i class="fas fa-stethoscope"></i> Oncology
          </span>
          <h1 class="dp-hero-name">Dr. Himanshu Gupta</h1>
          <p class="dp-hero-degrees">MBBS, MD / DNB - Medical Oncology</p>
          <p class="dp-hero-bio">Cancer &amp; Chemotherapy Specialist coordinating tumor chemotherapies and cancer screening packages.</p>
    ...
    <div class="row g-4 g-lg-5">
      ...
      <div class="col-lg-7">
        <div class="dp-profile-card">
          ...
          <h2 class="dp-section-title">About Dr. Himanshu Gupta</h2>
          <p class="dp-profile-text">Dr. Himanshu Gupta is the Oncology and Cancer Care Specialist at Sankalp Hospital. He manages chemotherapy protocols, coordinates multi-specialty cancer treatments, and leads cancer screening packages. He is committed to providing empathetic, patient-centered care and advanced cancer therapy.</p>
          ...
          <div class="dp-expertise-grid">
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Chemotherapy Administration</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Targeted Immunotherapy</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Cancer Screening &amp; Diagnosis</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Tumor Triage</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Palliative &amp; Supportive Care</span>
          </div>
      ...
      <div class="col-lg-5">
        <div class="dp-sticky-sidebar">
          ...
          <div class="dp-book-card">
            ...
            <p class="dp-book-sub">Schedule a consultation with Dr. Himanshu Gupta. Our coordinator will reach out to confirm.</p>
            <form id="detailed-booking-form" class="appointment-form">
              <input type="hidden" id="book-dept" value="oncology">
              <input type="hidden" id="book-doc" value="Dr. Himanshu Gupta">
              <div class="mb-3">
