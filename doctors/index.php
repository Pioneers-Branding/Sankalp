...
$pageCanonical = "https://www.sankalphospital.com/doctors/";
...
<?php
// ItemList structured data for the doctors directory (SEO)
$itemListElements = [];
$position = 1;
foreach ($doctorRegistry as $slug => $doc) {
    $itemListElements[] = [
        '@type'    => 'ListItem',
        'position' => $position++,
        'url'      => 'https://www.sankalphospital.com/doctors/' . $slug,
        'name'     => $doc['name'],
    ];
}
$doctorsSchema = [
    ...
    '@type'           => 'ItemList',
    'name'            => 'Medical Specialists at Sankalp Hospital, Ambikapur',
    'itemListElement' => $itemListElements,
];
?>
<script type="application/ld+json">
<?php echo json_encode($doctorsSchema, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT); ?>
</script>
