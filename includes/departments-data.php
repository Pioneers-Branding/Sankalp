...
$departments = [
    ...
    'dialysis' => [
        ...
        'theme_color' => 'var(--primary)',
        'gradient' => 'clinical',
        'overview' => 'Sankalp Hospital offers the leading dialysis services in Ambikapur, Chhattisgarh. Our dialysis unit is equipped with modern, high-efficiency dialysis machines and is staffed by experienced technicians and nursing professionals. We follow stringent sterilization protocols to ensure the highest level of patient safety and prevention of cross-infections. Whether you require routine hemodialysis or emergency renal support, our team is committed to providing compassionate, top-tier clinical care in Northern Chhattisgarh.',
        'features' => [
            ['icon' => 'fas fa-procedures', 'title' => '10+ Modern Dialysis Beds', 'desc' => 'Spacious and hygienic setup equipped with advanced hemodialysis machines.'],
            ['icon' => 'fas fa-shield-virus', 'title' => 'High Sterility Standards', 'desc' => 'Rigorous infection control protocols to prevent cross-contamination.'],
            ['icon' => 'fas fa-clock', 'title' => '24/7 Emergency Slots', 'desc' => 'Round-the-clock availability for critical patients requiring acute renal support.']
        ],
        'services' => [
            ['title' => 'Hemodialysis (Acute & Chronic)', 'desc' => 'High-efficiency blood filtration therapies for patients with chronic kidney disease (CKD) and acute kidney injury.'],
            ['title' => 'Emergency Renal Resuscitation', 'desc' => 'Rapid stabilization of patients experiencing acute renal failure or severe electrolyte imbalances.'],
            ['title' => 'Nephrology Consultations', 'desc' => 'Expert clinical advice on dietary modifications, fluid management, and pharmaceutical therapies for renal disorders.'],
            ['title' => 'AV Fistula Care & Education', 'desc' => 'Comprehensive monitoring of vascular access sites and patient guidance to prevent clots or infections.']
        ],
        'procedures' => [
            'Hemodialysis (Acute & Chronic)',
            'Double-Lumen Catheter Insertion (Jugular/Femoral)',
            'Arteriovenous (AV) Fistula Assessment & Care',
            'Continuous Renal Replacement Therapy (CRRT) coordination',
            'Fluid Overload & Electrolyte Management',
            'Pre-transplant Evaluation & Counseling'
        ],
        'why_choose_us' => [
            'Staffed by certified, highly experienced dialysis technicians and nurses.',
            'Adherence to strict sterilization guidelines including dialyzer reuse protocols.',
            'Cashless dialysis treatments under Ayushman Bharat and state health schemes.',
            'Integrated support with modular ICUs and 24/7 diagnostics.'
        ],
        'faqs' => [
            ['q' => 'How long does a standard dialysis session take?', 'a' => 'A typical hemodialysis treatment lasts about 3 to 4 hours and is usually required three times a week, depending on your doctor\'s prescription and kidney function.'],
            ['q' => 'Is hemodialysis painful?', 'a' => 'The dialysis process itself is not painful. However, you may feel a pinch when the needles are inserted into your AV fistula or graft. Some patients also experience mild muscle cramps or low blood pressure during the session.'],
            ['q' => 'What is an AV Fistula?', 'a' => 'An Arteriovenous (AV) Fistula is a surgical connection made between an artery and a vein, usually in the arm. It is created to provide a reliable, high-flow access point for the dialysis machine needles.'],
            ['q' => 'How do you prevent infections in the dialysis unit?', 'a' => 'We follow strict infection-control guidelines. This includes dedicated machines for patients with viral markers, rigorous sanitization of beds and equipment after every session, and using sterile, single-use disposables.'],
            ['q' => 'Is dialysis covered under government health schemes?', 'a' => 'Yes. Sankalp Hospital provides cashless dialysis services for eligible beneficiaries under the Ayushman Bharat scheme and other major corporate empanelments.']
        ]
    ]
];
